...
ArchEvents.handleClient('ClientRawInputEvent.MouseScrolled', (event) => {
    if (Client.player.mainHandItem == 'create:manual' && (Client.player.isCrouching() || Client.isShiftDown())) {
